...
class C_NetChan : public C_NetChannelInfo
{
public:
	virtual ~C_NetChan(void)
	{
	};

	virtual void SetDataRate(float rate) = 0;
	virtual bool RegisterMessage(C_NetMessage* msg) = 0;
	...
	virtual bool SendNetMsg(C_NetMessage& msg, bool bForceReliable = false, bool bVoice = false) = 0;
#ifdef POSIX
	...
	virtual C_NetChannelHandler* GetMsgHandler(void) const = 0;
...
public:
	...
	virtual void SetNetChannel(C_NetChan* netchan) = 0; // netchannel this message is from/for
	...
	virtual C_NetChan* GetNetChannel(void) const = 0;
...
{
public:
	virtual ~C_NetChannelHandler(void)
	{
	};

	virtual void ConnectionStart(C_NetChan* chan) = 0; // called first time network channel is established
...
class C_NetChannel : public C_NetChan
{
...
public:
	...
	C_NetChannelHandler* m_MessageHandler;	// who registers and processes messages
