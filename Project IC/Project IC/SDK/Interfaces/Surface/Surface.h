...
public:
	...
	{
		typedef void( FN)(void *, unsigned long);
	...
	{
		typedef void( FN)(void *, const wchar_t*, int, int);
	...
	{
		typedef void( FN)(void *, unsigned long, const char*, int, int, int, int, int, int, int);
		GetVFunc<FN>(this, 67)(this, font, windows_font_name, tall, weight, blur, scanlines, flags, 0, 0);
	}

	void GetTextSize(unsigned long font, const wchar_t* text, int& wide, int& tall)
	{
		typedef void( FN)(void *, unsigned long, const wchar_t*, int&, int&);
	...
	{
		typedef void( FN)(void *, int, int, int, int, unsigned int, unsigned int, bool);
	...
	{
		typedef void( FN)(void *, int, int, float, int);
	...
	void DrawSetTextureFile(int id, const char* filename, int hardwareFilter, bool forceReload) {
		typedef void( FN)(void *, int, const char*, int, bool);
	...
	void DrawSetTextureRGBA(int id, unsigned char const* rgba, int wide, int tall, int hardwareFilter = 0, bool forceReload = false) {
		typedef void( FN)(void *, int, unsigned char const*, int, int, int, bool);
	...
	void DrawGetTextureSize(int id, int& wide, int& tall) {
		typedef void( FN)(void *, int, int&, int&);
